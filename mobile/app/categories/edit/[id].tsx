...
export default function EditCategoryScreen() {
  ...
  // Popular formulário quando categoria carregada
  useEffect(() => {
    if (category) {
  ...
  // Categorias raiz disponíveis como pai (excluindo a própria categoria)
  const rootCategories = categories.filter(
    (c) => !c.parent_id && c.id !== categoryId
  );
  ...
  if (!category) {
    return (
      <View style={styles.centered}>
        ...
        <Text style={styles.emptyTitle}>Categoria não encontrada</Text>
      </View>
    );
  }
        ...
        >
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.fieldHint}>
              Deixe vazio para categoria raiz, ou selecione uma categoria pai.
            </Text>
