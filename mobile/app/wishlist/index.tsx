/**
 * Tela de Demanda Wishlist — mostra produtos mais desejados pelos clientes.
 * Exclusiva para vendedora/admin.
 */
...
export default function WishlistDemandScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        keyExtractor={(item) =>
          `${item.product_id}-${item.variant_id ?? 'all'}`
        }
