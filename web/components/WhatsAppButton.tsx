...
export default function WhatsAppButton({
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 bg-surface-800 text-white text-sm font-medium px-3 py-1.5 rounded-xl whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-white/10">
        Falar no WhatsApp
      </span>
    </a>
  );
