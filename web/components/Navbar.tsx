    ...
    >
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={openCart}
            className="relative flex items-center justify-center w-10 h-10 rounded-full text-white/70 hover:text-white hover:bg-white/8 transition-all"
          ...
          >
            ...
            {totalItems > 0 && (
              <span
                ...
                style={{ fontSize: "10px", background: "linear-gradient(135deg, #ff1a6c, #ff4f96)" }}
              >
      ...
      {open && (
        <div className="md:hidden bg-surface-800/98 backdrop-blur-xl border-t border-white/5 px-5 pb-6 pt-4 flex flex-col gap-4">
          ...
          <button
            ...
            className="flex items-center gap-3 text-white/80 font-medium py-2"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" className="w-5 h-5" strokeWidth="1.8">
              <path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z" strokeLinecap="round" strokeLinejoin="round"/>
              <line x1="3" y1="6" x2="21" y2="6" strokeLinecap="round"/>
            ...
            Carrinho {totalItems > 0 && <span className="text-pink-400 font-bold">({totalItems})</span>}
          </button>
          <a
            href={waUrl}
            target="_blank"
